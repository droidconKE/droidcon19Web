        ...
        if ( $('#lgx-countdown').length ) {
            ...
            $('#lgx-countdown').countdown(dataTime, function(event) {
                var $this = $(this).html(event.strftime(''
                    ...
                    + '<span class="lgx-days">%D <i class="lgx-da"> Days </i></span> '
        ...
        if (typeof google != 'undefined') {
            ...
            if ($('.map-canvas-default').length) {
                $(".map-canvas-default").googleMap({
                    ...
                    coords: [ -1.288917, 36.783214], // Map center (optional)
                ...
                $(".map-canvas-default").addMarker({
                    coords: [-1.288917, 36.783214], // GPS coords
                    title: 'iHub',
                    text: 'Junction, 6th floor Senteu Plaza, Galana / Lenana Road, Nairobi',
